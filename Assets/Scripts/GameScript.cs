...
public class GameScript : MonoBehaviour {
	...
	public GameObject yellowprofile,blueprofile, redprofile, greenprofile;
	public GameObject yellowdiceholder, bluediceholder, reddiceholder, greendiceholder;

	public GameObject menubutton;
	public GameObject menuscreen;
	public GameObject reallyscreen;
	...
	public GameObject greenwon,redwon,bluewon,yellowwon;
		...
		switch (MainMenuScript.howManyPlayers) 
		{
			case 2:
				if (totalRedInHouse > 3) 
				{
					...
					StartCoroutine ("GameCompletedRoutine");redwon.SetActive(true);
					redwon.transform.position = winners[0].transform.position;
					playerTurn = "NONE";
				}
				...
				if (totalGreenInHouse > 3) 
				{
					...
					StartCoroutine ("GameCompletedRoutine");greenwon.SetActive(true);
					greenwon.transform.position = winners[0].transform.position;
					playerTurn = "NONE";
				}
				break;
			...
			if (totalBlueInHouse > 3 && totalRedInHouse < 4 && totalYellowInHouse < 4 && playerTurn == "BLUE") 
				{
					...
					//bluewon.transform.position = winners[0].transform.position;
			...
			if (totalYellowInHouse > 3 && totalRedInHouse < 4 && totalBlueInHouse < 4 && playerTurn == "YELLOW") 
				{
					...
					//yellowwon.transform.position = winners[0].transform.position;
				...
				if (totalRedInHouse > 3 && totalBlueInHouse > 3 && totalYellowInHouse < 4) 
				{
					...
					redwon.transform.position = winners[0].transform.position;
					bluewon.SetActive(true);
					bluewon.transform.position = winners[1].transform.position;
				...
				if (totalBlueInHouse > 3 && totalYellowInHouse > 3 && totalRedInHouse < 4) 
				{
					...
					//yellowScreen.SetActive (true);
					//blueScreen.SetActive (true);
					StartCoroutine ("GameCompletedRoutine");yellowwon.SetActive(true);
					yellowwon.transform.position = winners[0].transform.position;
					bluewon.SetActive(true);
					bluewon.transform.position = winners[1].transform.position;
				...
				if (totalYellowInHouse > 3 && totalRedInHouse > 3 && totalBlueInHouse < 4) 
				{
					...
					redwon.transform.position = winners[0].transform.position;
					yellowwon.SetActive(true);
					yellowwon.transform.position = winners[1].transform.position;
			...
			if (totalBlueInHouse > 3 && totalGreenInHouse > 3 && totalRedInHouse < 4 && totalYellowInHouse < 4 && (playerTurn == "BLUE" || playerTurn == "GREEN")) 
				{		
					...
					//bluewon.transform.position = winners[0].transform.position;
					//redwon.SetActive(true);
					//redwon.transform.position = winners[1].transform.position;
			...
			if (totalRedInHouse > 3 && totalGreenInHouse > 3 && totalYellowInHouse < 4 && totalBlueInHouse < 4&& (playerTurn == "RED" || playerTurn == "GREEN")) 
				{
					...
					//redwon.transform.position = winners[0].transform.position;
					//greenwon.SetActive(true);
					//greenwon.transform.position = winners[1].transform.position;
				...
				if (totalRedInHouse > 3 && totalGreenInHouse > 3 && totalBlueInHouse > 3 && totalYellowInHouse < 4) 
				{
					...
					greenwon.transform.position = winners[1].transform.position;
					bluewon.SetActive(true);
					bluewon.transform.position = winners[2].transform.position;
				...
				if (totalRedInHouse > 3 && totalGreenInHouse > 3 && totalYellowInHouse > 3 && totalBlueInHouse < 4) 
				{
					...
					greenwon.transform.position = winners[1].transform.position;
					yellowwon.SetActive(true);
					yellowwon.transform.position = winners[2].transform.position;
				...
				if (totalBlueInHouse > 3 && totalGreenInHouse > 3 && totalYellowInHouse > 3 && totalRedInHouse < 4) 
				{
					...
					//greenScreen.SetActive (true);
					//yellowScreen.SetActive (true);
					StartCoroutine ("GameCompletedRoutine");bluewon.SetActive(true);
					bluewon.transform.position = winners[0].transform.position;
					greenwon.SetActive(true);
					greenwon.transform.position = winners[1].transform.position;
					yellowwon.SetActive(true);
		...
		switch (MainMenuScript.howManyPlayers) 
		{
			case 2:
				if (playerTurn == "RED") 
				{
					...
					yellowdiceholder.GetComponent<Image>().sprite = rightoff;
					greendiceholder.GetComponent<Image>().sprite = rightoff;
					reddiceholder.GetComponent<Image>().sprite = lefton;
					bluediceholder.GetComponent<Image>().sprite = leftoff;
				...
				if (playerTurn == "GREEN") 
				{
					...
					yellowdiceholder.GetComponent<Image>().sprite = rightoff;
					greendiceholder.GetComponent<Image>().sprite = righton;
					reddiceholder.GetComponent<Image>().sprite = leftoff;
					bluediceholder.GetComponent<Image>().sprite = leftoff;
			...
			case 3:
				...
				if (playerTurn == "YELLOW") 
				{
					...
					yellowdiceholder.GetComponent<Image>().sprite = righton;
					greendiceholder.GetComponent<Image>().sprite = rightoff;
					reddiceholder.GetComponent<Image>().sprite = leftoff;
					bluediceholder.GetComponent<Image>().sprite = leftoff;
					frameRed.SetActive (false);
				...
				if (playerTurn == "BLUE") 
				{
					...
					greendiceholder.GetComponent<Image>().sprite = rightoff;
					reddiceholder.GetComponent<Image>().sprite = leftoff;
					bluediceholder.GetComponent<Image>().sprite = lefton;
					frameRed.SetActive (false);
					frameGreen.SetActive (false);
...

	{
		...
		//righton = Resources.Load<Sprite>("unde-1");
		//rightoff = Resources.Load<Sprite>("unde");
		//lefton = Resources.Load<Sprite>("unde-3");
		//leftoff = Resources.Load<Sprite>("unde-2");
		...
		{
			case 2:
				yellowprofile.SetActive(false);
				blueprofile.SetActive(false);
				reddiceholder.GetComponent<Image>().sprite = lefton;
				break;

			case 3:
				greenprofile.SetActive(false);
				reddiceholder.GetComponent<Image>().sprite = leftoff;
				yellowdiceholder.GetComponent<Image>().sprite = righton;
				break;
		}
